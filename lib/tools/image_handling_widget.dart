  ...
  Future<void> _pickImage() async {
    ...
    if (_isMultipleSelection) {
      ...
      final imageDescriptions =
          List.filled(pickedImages.length, _imageDescriptionController.text);
      _imageDescriptionController.clear();

      setState(() {
        _imagePreviews.addAll(pickedImages);
        _imageDescriptions.addAll(imageDescriptions);
        _isEditingList
            .addAll(List.generate(pickedImages.length, (index) => false));
      });

      widget.onImagesSelected(_imagePreviews, _imageDescriptions);
    } else {
      setState(() {
      ...
      if (pickedImage != null) {
        ...
        setState(() {
          _imagePreviews.add(pickedImage);
          _imageDescriptions.add(imageDescription);
